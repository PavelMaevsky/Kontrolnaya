...
Снабдить репозиторий оформленным текстовым описанием решения (файл README.md)-manual.md
...
![](Kontrolnaya.jpg)
3. Программа решающая данную задачу находится в разделе Program.cs